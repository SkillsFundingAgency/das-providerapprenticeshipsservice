...
namespace SFA.DAS.ProviderApprenticeshipsService.Application.UnitTests.Commands.UndoApprenticeshipUpdate
{
    ...
    {
        private IRequestHandler<UndoApprenticeshipUpdateCommand> _handler;
        private Mock<IProviderCommitmentsApi> _commitmentsApi;
        private Mock<IValidator<UndoApprenticeshipUpdateCommand>> _validator;

        [SetUp]
        public void Arrange()
        {
            _validator = new Mock<IValidator<UndoApprenticeshipUpdateCommand>>();
