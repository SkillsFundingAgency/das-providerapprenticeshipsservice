...
namespace SFA.DAS.ProviderApprenticeshipsService.Web.Controllers
{
    ...
    public class CommitmentController : Controller
    {
        ...
        [HttpPost]
        [Route("{hashedCommitmentId}/UploadApprenticeships")]
        public ActionResult UploadApprenticeships(UploadApprenticeshipsViewModel uploadApprenticeshipsViewModel, [Bind(Include = "Attachment")]HttpPostedFileBase upload)
        {
            ...
            if (uploadApprenticeshipsViewModel.Attachment != null)
            {
                ...
                return RedirectToAction("Details", new { uploadApprenticeshipsViewModel.ProviderId, uploadApprenticeshipsViewModel.HashedCommitmentId});
            }
