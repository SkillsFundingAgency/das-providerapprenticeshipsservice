...
{
    [TestFixture]
    public class WhenValidatingReviewApprenticeshipUpdateViewModel
    {
        private ReviewApprenticeshipUpdateViewModelValidator _validator;

        [SetUp]
        public void Arrange()
        {
            _validator = new ReviewApprenticeshipUpdateViewModelValidator();
        }
