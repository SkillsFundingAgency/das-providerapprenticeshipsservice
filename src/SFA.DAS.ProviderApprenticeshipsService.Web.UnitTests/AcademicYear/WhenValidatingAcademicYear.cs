...
namespace SFA.DAS.ProviderApprenticeshipsService.Web.UnitTests.AcademicYear
{
    ...
    public class WhenValidatingAcademicYear
    {
        ...
        private Mock<IAcademicYear> _academicYear;
        ...
        public void SetUp()
        {
            ...
            _academicYear = new Mock<IAcademicYear>();
        }
        ...
        public void ThenAcademicYearValidationShouldReturnExpectedResult(DateTime currentDate, DateTime startDate, AcademicYearValidationResult expectedResult)
        {
            ...
            _academicYear.SetupGet(x => x.CurrentAcademicYearStartDate).Returns(yearStartDate);
            _academicYear.SetupGet(x => x.CurrentAcademicYearFundingPeriod).Returns(fundingPeriodDate);

            _academicYearValidator = new AcademicYearValidator(_mockCurrentDateTime.Object, _academicYear.Object);
            //Act
