...
public class HomeControllerTest
{
    ...
    public void Arrange()
    {
        ...
        _userIdentityService.Setup(x =>
                x.UpsertUserIdentityAttributes(It.IsAny<string>(), It.IsAny<long>(), It.IsAny<string>(),
                    It.IsAny<string>()))
    ...
    public void Index_When_User_Unauthorized_ShouldReturnValidViewModel()
    {
        ...
        _sut = new Web.Controllers.HomeController(_providerApprenticeshipsServiceConfiguration,
        ...
        string authType)
    {
        ...
        vr.RouteName.Should().NotBeNullOrEmpty();
        vr.RouteName.Should().Be(RouteNames.AccountHome);
        _mockAuthenticationOrchestrator.Verify(
            x => x.SaveIdentityAttributes(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(),
