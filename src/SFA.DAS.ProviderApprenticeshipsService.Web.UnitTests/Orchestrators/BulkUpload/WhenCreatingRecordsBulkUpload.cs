...
namespace SFA.DAS.ProviderApprenticeshipsService.Web.UnitTests.Orchestrators.BulkUpload
{
    ...
    public class WhenCreatingRecordsBulkUpload : BulkUploadTestBase
    {
        ...
        public WhenCreatingRecordsBulkUpload()
        {
            ...
            builder.Append(@"Abba123,1113335559,Froberg,Chris,1998-12-08,SE123321C,2,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 Abba123,1113335559,Froberg1,Chris1,1998-12-08,SE123321C,3,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 ABBA123,1113335559,Froberg2,Chris2,1998-12-08,SE123321C,3,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 ABBA123,1113335559,Froberg3,Chris3,1998-12-08,SE123321C,2,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 ,,,,,,,,,,,,,,
 ABBA123,1113335559,Chris3,Froberg3,1998-12-08,SE123321E,2,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 ABBA123,1113335559,Chris2,StartEndDateError,1998-12-08,SE123321C,2,2120-08,2119-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com
 ABBA123,1113335559,Chris3,Froberg3WrongDateFormat,1998-12-08,SE123321C,2,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com");
        ...
        public void ThenShouldNotLogInfoWhenNoHeaderRecord()
        {
            ...
            builder.AppendLine("Abba123,1113335559,Froberg,Chris,1998-12-08,SE123321C,2,2120-08,2125-08,1500,,Employer ref,Provider ref,XYZUR,apprentice1@test.com");
        ...
        public void ThenShouldLogInfoForMissingFields(string header)
        {
            ...
            var inputData = $"{header}" +
                            @"
                            Abba123,1113335559,Froberg,Chris,1998-12-08,SE123321C,2,2120-08,2125-08,1500,,Employer ref,Provider ref,apprentice1@test.com,XYZUR";
